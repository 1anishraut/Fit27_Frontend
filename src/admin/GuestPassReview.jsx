              ...
              {guestPasses.map((gp) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* ACTIONS */}
                    <div className="md:col-span-1 flex gap-2 md:justify-center">
                      <button
                        disabled={isProcessed || loadingId === gp._id}
                        onClick={() => updateStatus(gp._id, "GRANTED")}
                        className="px-2 py-1 text-xs rounded border border-green-500 text-green-600 hover:bg-green-100 dark:hover:bg-green-900/20 disabled:opacity-40"
                      >
                        Grant
                      </button>
                      ...
                      <button
                        ...
                        className="px-2 py-1 text-xs rounded border border-red-500 text-red-600 hover:bg-red-100 dark:hover:bg-red-900/20 disabled:opacity-40"
                      >
                        Deny
                      </button>
                      ...
                      {gp.user && (
                        <button
                          ...
                          className="px-2 py-1 text-xs rounded border border-gray-400 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#1f1f23]"
                        >
                          View User
                        </button>
                      )}
