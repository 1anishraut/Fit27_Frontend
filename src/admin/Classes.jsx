...
export default function Classes() {
  ...
  /* =====================================================
        ACTIVE / INACTIVE TOGGLE (BACKEND CONNECTED)
  ===================================================== */
  ...
  return (
    <div className="p-6 min-h-screen bg-[#F2F0EF] dark:bg-[#09090B] transition-all">
      ...
      <div className="w-full bg-white dark:bg-[#0D0D0F] rounded-xl p-4 shadow-2xl border border-gray-400 dark:border-gray-700">
        {/* TABLE WRAPPER - NO SCROLLBAR + DROPDOWN FIX */}
              ...
              {classes.length === 0 ? (
                ...
                classes.map((item) => (
                  ...
                  >
                    ...
                    <td className="p-3 text-gray-200">{item.capacity}</td>
                    <td className="p-3 text-gray-200">
                      {item.remainingCapacity || item.capacity}
                    </td>
                    <td className="p-3 text-gray-200">₹{item.cost}</td>
      ...
      {/* SCROLLBAR REMOVAL (INLINE CSS HACK SAFE) */}
      <style>{`
